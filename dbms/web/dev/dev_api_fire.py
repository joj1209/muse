...
for rsac_gut_fstt_ogidNm in  rsac_gut_fstt_ogidNm_list:
    ...
    ap_svc1 = 'getTrafficAccidentEmgActStats'   # 소방청 구급통계 교통사고구급활동현황 목록조회
    ...
    for elem in iter_elem:
        ...
        foreigner['구급사고종별코드'] = elem.find('rlifAcdAsmCdNm').text
        foreigner['환자유형'] = elem.find('rlifOccrTyCdNm').text
...
df.to_excel(f"fire_{rcpt_ym}.xlsx")